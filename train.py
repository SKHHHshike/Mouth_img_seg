...
model = get_model(width = 128, height = 64,  model_name = 'lw_rf_net_unet', n_classes = n_classes)
# model = unet()
...
def train():
    ...
    myGene = trainGenerator(2,'data/intraoralArea/train_more_data','image','label',data_gen_args, n_classes=n_classes,target_size = img_target_size, mask_target_size = mask_target_size, save_to_dir = None)
